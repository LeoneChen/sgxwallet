...
AC_DEFUN([SGX_INIT],[
	...
	AC_SUBST(SGX_ENCLAVE_LDADD,
		["-Wl,--whole-archive -lSGXSanRTEnclave -l\$(SGX_TRTS_LIB) -Wl,--no-whole-archive -Wl,--start-group \$(SGX_EXTRA_TLIBS) -lsgx_tstdc -lsgx_tcrypto -l\$(SGX_TSERVICE_LIB) -Wl,--end-group -Wl,-Bsymbolic -Wl,-eenclave_entry -Wl,--export-dynamic -Wl,--defsym,__ImageBase=0 --shared"])
	], [
	AC_SUBST(SGX_ENCLAVE_CFLAGS,
