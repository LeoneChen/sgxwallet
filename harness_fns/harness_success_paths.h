...
// harness_ecdsa_sign_burst moved to harness_micro.h (function body + registration)
...
// DISABLED: replaced by harness_micro_decryption_share_valid_g2 (cum=1689 vs cum=2610, zero-consumption)
...
// HARNESS_REGISTER(harness_encrypt_roundtrip, 65)  // DISABLED: redundant with harness_micro_minimal_encrypt (cum=780) + decrypt harnesses
// HARNESS_REGISTER(harness_setsek_success_path, 55)  // DISABLED: CALL_ONCE abort
// DISABLED: redundant with minimal_ecdsa_sign (cum=295) which covers GenerateKey+Sign
// HARNESS_REGISTER(harness_ecdsa_success_path, 55)
// DISABLED: redundant with minimal_bls_sign (cum=225) which covers GenerateBLSKey+BlsSign
// HARNESS_REGISTER(harness_bls_success_path, 55)
// DISABLED: redundant with minimal_dkg_share (cum=1980) which covers GenDkgSecret+DecryptDkgSecret
// HARNESS_REGISTER(harness_dkg_decrypt_path, 40)
// DISABLED: redundant with minimal_dkg_share + minimal_dkg_verify combo
// HARNESS_REGISTER(harness_dkg_full_workflow, 60)
// DISABLED: redundant with minimal_bls_create (cum=2120)
// HARNESS_REGISTER(harness_bls_create_key_path, 40)
// DISABLED: redundant with minimal_bls_create_v2 (cum=2265)
// HARNESS_REGISTER(harness_bls_create_key_v2_path, 40)
// DISABLED: redundant with minimal_dkg_verify_v2 (cum=2335)
// HARNESS_REGISTER(harness_dkg_verify_v2_path, 55)
// DISABLED: redundant with minimal_bls_sign + minimal_bls_create combo
...
// HARNESS_REGISTER(harness_deep_bls_sign, 80)  // DISABLED: redundant with harness_minimal_bls_sign (cum=225, zero-consumption)
// HARNESS_REGISTER(harness_deep_create_bls_key, 80)  // DISABLED: redundant with harness_minimal_bls_create (cum=2320)
// HARNESS_REGISTER(harness_deep_create_bls_key_v2, 80)  // DISABLED: redundant with harness_minimal_bls_create_v2 (cum=2465)
HARNESS_REGISTER(harness_deep_decrypt_key, 70)
HARNESS_REGISTER(harness_deep_decrypt_dkg, 70)
// harness_ecdsa_sign_burst moved to harness_micro.h for better visibility
