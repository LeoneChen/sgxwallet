...
// DISABLED: redundant with harness_micro_ecdsa_corrupt_key_fixed (cum=1230, zero consumption)
// HARNESS_REGISTER(harness_corrupted_key_ecdsa, 45)
// DISABLED: redundant with harness_micro_ecdsa_bad_hash_fixed (cum=1180, zero consumption)
